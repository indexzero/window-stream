...
// in `this.data`.
//
Object.defineProperty(Window.prototype, 'sum', {
  enumerable: true,
  get: function () {
...
// in `this.data`.
//
Object.defineProperty(Window.prototype, 'median', {
  enumerable: true,
  get: function () {
...
// in `this.data`.
//
Object.defineProperty(Window.prototype, 'mean', {
  enumerable: true,
  get: function () {
    if (!this.data.length) {
      return 0;
...
// in `this.data`. 
//
Object.defineProperty(Window.prototype, 'variance', {
  enumerable: true,
  get: function () {
    if (!this.data.length) {
      return 0;
...
//
Object.defineProperty(Window.prototype, 'stdDev', {
  enumerable: true,
  get: function () {
...
// in `this.data`.
//
Object.defineProperty(Window.prototype, 'sorted', {
  enumerable: true,
  get: function () {
    return this.data
      .map(function (data) {
