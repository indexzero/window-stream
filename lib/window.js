...
//
// ### @min {number}
// Return the minimum metric value in the window
//
...
//
// ### @max {number}
// Return the maximum metric value in the window
//
Window.prototype.max = function () {
  return this.sorted()[this.data.length - 1];
};
...
// in `this.data`. This also takes a property and fn arguments
// which are optional but can overload our defaults
//
Window.prototype.sorted = function (prop, fn) {
  if (!fn && typeof prop === 'function') {
    fn = prop;
    prop = 'metric';
  }
